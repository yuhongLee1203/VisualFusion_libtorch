#ifndef HOMOGRAPHY_MANAGER_H_
#define HOMOGRAPHY_MANAGER_H_
...
class HomographyManager {
 public:
   ...
   */
  int get_fallback_count() const { return fallback_count_; }

  /**
   * @brief 增加 fallback 計數
   */
  void increment_fallback() { fallback_count_++; }

  /**
   * @brief 重置 fallback 計數
   */
  void reset_fallback() { fallback_count_ = 0; }
